...
def parse_amfi_text(raw_text: str) -> list[ParsedNavRow]:
    ...
    for line in raw_text.splitlines():
        ...
        # parts[] was already stripped above; isin_growth/isin_div are
        # either a clean string or None (AMFI leaves these columns
        # blank for many schemes) — do not re-call .strip() on them,
        # since that crashes with AttributeError when they're None.
        rows.append(
            ParsedNavRow(
