...
LightGBM is a heavy optional dependency; the import is deferred to
...
leaderboard (same pattern used for TensorFlow/LSTM and CatBoost below).
"""
...
class LightGBMModel(BaseForecastModel):
    ...
    def fit(self, X: pd.DataFrame, y: pd.Series) -> "LightGBMModel":
        try:
            ...
            raise ImportError(
                "lightgbm is not installed. Install it to enable this model."
            ) from exc
