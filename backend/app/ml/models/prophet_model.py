...
Prophet is a heavy optional dependency; the import is deferred to
...
leaderboard (same pattern used for TensorFlow/LSTM, LightGBM, XGBoost).
"""
...
class ProphetModel(BaseForecastModel):
    ...
    def fit(self, series: pd.Series) -> "ProphetModel":
        try:
            ...
            raise ImportError(
                "prophet is not installed. Install it to enable this model."
            ) from exc
